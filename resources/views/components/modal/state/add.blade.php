<div id="addStateModal" class="fixed inset-0 items-center justify-center hidden bg-gray-900/50">
    <div class="bg-white rounded-lg shadow-lg w-1/3">
        <div class="flex justify-between items-center border-b p-4">
            <h3 class="text-lg  font-semibold">Tambah Provinsi
                <span class="text-blue-400">({{ \App\Models\Country::find(request('country_id'))->name }})</span>
            </h3>
            <button data-close-modal="addStateModal" class="text-gray-500 hover:text-gray-700">
        ...
        <div class="p-4">
            <form action="{{ route('state.store') }}" method="POST">
                ...
                <div class="flex justify-end">
                    <button type="button" data-close-modal="addStateModal"
